...
productos en la sesión real del comprador. La versión 0.3.6 conecta el botón de Convive, reemplaza el carro anterior sólo después de una confirmación explícita, abre el carro al terminar e incluye adaptadores
