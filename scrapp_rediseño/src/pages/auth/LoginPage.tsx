          ...
          <div className="max-w-md">
            <div className="mb-8 animate-fade-in">
              <img 
                src={logoImgW} 
                alt="Scrapp Monitor" 
                className="h-60 mb-6 drop-shadow-2xl"
              />
            </div>
            
            <h1 className="text-4xl font-bold mb-6 animate-slide-up">
              Monitoreo de Reputación
              <span className="block text-primary-200 mt-2">en Tiempo Real</span>
            </h1>
            
            <p className="text-lg text-white/90 mb-8 animate-slide-up animation-delay-200">
              Controla la presencia de tu marca en medios chilenos las 24 horas del día
            </p>
            ...
            <div className="space-y-4 animate-slide-up animation-delay-400">
              <div className="flex items-center gap-3 text-white/80">
                ...
                <span>Monitoreo 24/7 de canales de TV</span>
              </div>
              <div className="flex items-center gap-3 text-white/80">
                <svg className="w-6 h-6 text-primary-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span>Detección automática de menciones</span>
              </div>
              <div className="flex items-center gap-3 text-white/80">
                <svg className="w-6 h-6 text-primary-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span>Clips de video instantáneos</span>
              </div>
            </div>

            <div className="mt-12 p-6 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 animate-fade-in animation-delay-600">
              <div className="flex items-center gap-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 bg-primary-400/30 rounded-full flex items-center justify-center">
                ...
                <div>
                  <p className="text-sm text-white/60">Menciones detectadas hoy</p>
