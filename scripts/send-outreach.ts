    ...
    return `
        <div style="font-family: sans-serif; padding: 20px; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #eee; border-radius: 12px;">
            ...
            <div style="margin: 30px 0;">
                <a href="https://convive.app/login" style="display: inline-block; padding: 14px 28px; background-color: #C8705A; color: white; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px;">
                    Ver Demo Gratis
                </a>
            </div>
