...
REGLAS ESTRICTAS:
1. Si necesitas actualizar la pizarra virtual (por ejemplo, para mostrar una nueva diapositiva o un resumen en markdown), debes envolver ese contenido estrictamente con las etiquetas [PIZARRA] y [/PIZARRA].
   Ejemplo:
   [PIZARRA]
