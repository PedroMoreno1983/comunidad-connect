...
export function ProductDetailModal({ item, isOpen, onClose, categoryLabel, onChat, onBuy }: ProductDetailModalProps) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="overflow-hidden rounded-lg border-none bg-surface p-0 shadow-sm sm:max-w-4xl">
                <div className="flex max-h-[90vh] flex-col overflow-y-auto overflow-x-hidden md:flex-row">
                    <div className="relative flex min-h-[320px] bg-elevated md:w-1/2">
                        ...
                        <div className="absolute left-6 top-6 flex flex-wrap gap-2">
                            <span className="rounded-lg border border-white/20 bg-black/40 px-4 py-2 text-xs font-bold uppercase tracking-widest text-white backdrop-blur-md">
                                {categoryLabel}
                            </span>
                            <span className={`rounded-lg border px-4 py-2 text-xs font-bold uppercase tracking-widest backdrop-blur-md ${
                                isUnavailable
                    ...
                    <div className="space-y-10 overflow-y-auto bg-surface p-8 md:w-1/2 md:p-12">
                        ...
                        <section className="space-y-4">
                            <h3 className="ml-1 text-[11px] font-semibold uppercase tracking-[0.3em] cc-text-tertiary">
                                Modalidades
                            </h3>
                            <div className="grid gap-4">
                                ...
                                {item.allowSwap && (
                                    <div className="space-y-3 rounded-lg border border-purple-100/30 bg-purple-50/30 p-5 dark:border-purple-500/10 dark:bg-purple-500/5">
                                        <div className="flex items-center gap-4">
                                            <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-brand-100 text-brand-600 dark:bg-purple-500/20 dark:text-brand-400">
                                                <Repeat className="h-5 w-5" />
                                            </div>
                                            <div>
                                                <p className="font-semibold cc-text-primary">Permuta</p>
                                ...
                                {item.allowBarter && (
                                    <div className="space-y-3 rounded-lg border border-emerald-100/30 bg-emerald-50/30 p-5 dark:border-emerald-500/10 dark:bg-emerald-500/5">
                                        <div className="flex items-center gap-4">
                                            <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-success-bg text-success-fg">
                                                <Sparkles className="h-5 w-5" />
                                            </div>
                                            <div>
                                                <p className="font-semibold cc-text-primary">Trueque comunitario</p>
                        ...
                        <section className="grid grid-cols-2 gap-4">
                            <div className="rounded-lg border border-subtle bg-elevated/30 p-5">
                                <p className="mb-2 text-[10px] font-semibold uppercase tracking-widest text-slate-400">Confianza</p>
                            ...
                            <div className="rounded-lg border border-subtle bg-elevated/30 p-5">
                                <p className="mb-2 text-[10px] font-semibold uppercase tracking-widest text-slate-400">Publicado</p>
                                <div className="flex items-center gap-3">
                        ...
                        <div className="space-y-6 border-t border-subtle pt-8">
                            <div className="flex items-center gap-5 rounded-lg border border-subtle bg-slate-50/50 p-5 dark:bg-slate-800/20">
