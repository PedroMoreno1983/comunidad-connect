    ...
    return (
        <div className="flex items-center gap-3 min-w-[200px]">
            <button
                ...
                className={`p-2 rounded-full transition-colors ${isSender ? "text-emerald-500 bg-white" : "text-slate-500 bg-elevated"
                    }`}
            >
            ...
            <div className="flex-1 space-y-1">
                <div className={`h-1 rounded-full overflow-hidden ${isSender ? "bg-emerald-700/30" : "bg-elevated"}`}>
                    <div
                        className={`h-full transition-all duration-100 ${isSender ? "bg-emerald-100" : "bg-elevated"}`}
