...
export function WaterConsumptionChart({ data }: WaterConsumptionChartProps) {
    if (!data || data.length === 0) {
        return (
            <div className="rounded-[2.5rem] border border-subtle bg-elevated/50 p-8 text-center">
    ...
    return (
        <div className="space-y-8">
            <section className={`rounded-[2.5rem] border p-8 transition-all ${
                isEfficient
                ...
                <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
                    <div className="flex items-center gap-6">
                        ...
                        <div className="space-y-1">
                            <h2 className="text-2xl font-black leading-tight cc-text-primary">
                    ...
                    <div className="rounded-2xl border border-subtle bg-surface px-6 py-4 shadow-sm">
                        <p className="mb-1 text-[10px] font-black uppercase tracking-widest text-slate-400">Tu consumo actual</p>
                        <p className="text-2xl font-black cc-text-primary">{currentMonth.personal} m³</p>
                    </div>
                </div>
            </section>

            <section className="space-y-10 rounded-[3rem] border border-subtle bg-surface p-8 shadow-xl shadow-slate-200/20 dark:shadow-none md:p-12">
                <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
                        ...
                        <BarChart data={data} margin={{ top: 20, right: 0, left: -20, bottom: 0 }}>
                            ...
                            <Tooltip
                                ...
                                content={({ active, payload }) => {
                                    ...
                                    return (
                                        <div className="space-y-4 rounded-2xl border border-white/10 bg-canvas p-6 text-white shadow-2xl">
