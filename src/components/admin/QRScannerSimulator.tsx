            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-[3rem] p-10 border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/20 dark:shadow-none space-y-8">
                    <div className="space-y-2">
                        ...
                        <h1 className="text-3xl font-black text-slate-900 dark:text-white">Escáner Digital</h1>
                    </div>
                    ...
                    <AnimatePresence mode="wait">
                        {scanResult ? (
                            ...
                            <motion.div
                                ...
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                className="bg-slate-100 dark:bg-slate-800/50 rounded-[3rem] p-16 flex flex-col items-center justify-center text-center space-y-6 border border-dashed border-slate-300 dark:border-slate-700 h-full"
                            >
                                <div className="w-20 h-20 bg-white dark:bg-slate-800 rounded-3xl shadow-xl flex items-center justify-center text-slate-300">
                                    <Search className="h-10 w-10" />
                                </div>
                                <div className="space-y-2">
                                    <h3 className="text-xl font-black text-slate-900 dark:text-white">Listo para Escanear</h3>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-[3rem] border border-slate-100 dark:border-slate-800 overflow-hidden shadow-xl shadow-slate-200/20 dark:shadow-none">
                <div className="p-10 border-b border-slate-50 dark:border-slate-800 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        <h3 className="text-xl font-black text-slate-900 dark:text-white">Historial de Accesos QR</h3>
                    </div>
                </div>
                    ...
                    {[
                        ...
                        <div key={i} className="p-8 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-800/20 transition-colors">
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    <p className="font-black text-slate-900 dark:text-white">{log.name}</p>
                                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Unidad {log.unit}</p>
                                </div>
                            </div>
                            <div className="text-right">
                                <p className="text-sm font-black text-slate-900 dark:text-white">{log.time}</p>
