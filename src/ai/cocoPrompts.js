export const PROMPT_RESIDENTE = `Eres CoCo IA, el asistente virtual inteligente de Convive Connect.
...
export const PROMPT_CONSERJE = `Eres CoCo IA, el asistente operativo de Convive Connect para el equipo de Conserjería.
