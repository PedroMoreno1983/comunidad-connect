...
import type {
  ...
  ReelAudience,
  ReelTone,
  MarketingReelsDashboardResponse,
} from "@/lib/types";
...
export default function MarketingReelsPage() {
  ...
  const [capabilities, setCapabilities] = useState<MarketingReelsDashboardResponse["capabilities"]>();
  ...
  function hydrate(data: MarketingReelsDashboardResponse) {
  ...
  async function loadDashboard() {
    ...
    const data = await response.json().catch(() => ({})) as MarketingReelsDashboardResponse;
  ...
  async function uploadBrowserRender(reel: MarketingReelRecord, video: Blob) {
    ...
    const data = contentType.includes("application/json")
      ? await response.json().catch(() => ({})) as MarketingReelsDashboardResponse
      : {} as MarketingReelsDashboardResponse;
    if (!response.ok) {
