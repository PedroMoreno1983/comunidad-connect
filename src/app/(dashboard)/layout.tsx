    ...
    return (
        <div className="flex h-screen bg-transparent overflow-hidden relative">
            ...
            <main className="flex-1 overflow-y-auto relative z-10 flex flex-col">
                {/* Demo Banner */}
                {isDemoUser && (
                    <div className="text-white px-4 py-2.5 flex items-center justify-center gap-3 text-sm font-medium z-50 sticky top-0 shadow-md" style={{ backgroundColor: 'var(--cc-brand-500)' }}>
