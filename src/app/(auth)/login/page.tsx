            ...
            <div className="mx-auto grid min-h-[calc(100vh-4rem)] w-full max-w-6xl items-center gap-8 lg:grid-cols-[1fr_440px]">
                <section className="hidden space-y-8 lg:block">
                    ...
                    <div className="grid max-w-2xl grid-cols-3 gap-3">
                        {["Roles separados", "Datos auditables", "Operacion trazable"].map((item) => (
                ...
                <section className="rounded-lg border border-subtle bg-surface p-6 shadow-sm sm:p-8">
                    <div className="mb-8 flex items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="mt-2 text-sm cc-text-secondary">Usa tus credenciales reales para operar tu comunidad.</p>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <Input id="email" type="email" value={email} onChange={(event) => setEmail(event.target.value)} placeholder="tu@email.com" required className="pl-10" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <Input id="password" type={showPassword ? "text" : "password"} value={password} onChange={(event) => setPassword(event.target.value)} placeholder="Tu contrasena" required className="pl-10 pr-10" />
