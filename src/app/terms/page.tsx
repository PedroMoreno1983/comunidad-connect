            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="prose prose-slate dark:prose-invert">
                    <p className="text-lg cc-text-secondary leading-relaxed mb-6">
                        Última actualización: Noviembre 2026. Al utilizar Convive Connect, usted acepta los siguientes términos y condiciones.
                    </p>
                    <div className="space-y-8 bg-surface border border-subtle rounded-3xl p-8">
                        ...
                        <section>
                            ...
                            <p className="cc-text-secondary">
                                Convive Connect facilita la comunicación y gestión de pagos pero no asume responsabilidad directa por disputas entre la comunidad, la conserjería ni administradores locales.
                            </p>
                        </section>
                        <section>
