-- Devuelve sales_unit junto con sku y offer_id en el catalogo por lote.
-- La columna ya existe y esta poblada; este cambio solo completa el JSON
-- consumido por la aplicacion. Conserva SECURITY INVOKER y acceso exclusivo
-- para service_role.
