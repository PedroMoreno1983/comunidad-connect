-- Migration 007: Service Requests Table (Complete Fix)
-- This migration can be run safely even if the table already exists

-- First, drop the table if it exists and recreate it properly
DROP TABLE IF EXISTS service_requests CASCADE;

-- Create service_requests table with all columns
